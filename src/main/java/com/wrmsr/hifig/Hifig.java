 ...
 */
package com.wrmsr.hifig;

import com.google.common.collect.ImmutableList;
import com.wrmsr.hifig.mergeable.Mergeable;
import com.wrmsr.hifig.mergeable.MergeableConfigContainer;
import com.wrmsr.hifig.util.ImmutablePair;
...
import static com.wrmsr.hifig.util.ImmutableCollectors.toImmutableMap;
import static com.wrmsr.hifig.util.ImmutableCollectors.toImmutableSet;
import static com.wrmsr.hifig.util.Jvm.getThisJarFile;
import static com.wrmsr.hifig.util.Maps.transformKeys;
import static com.wrmsr.hifig.util.Serialization.OBJECT_MAPPER;
import static com.wrmsr.hifig.util.Strings.getSystemProperties;

public final class Hifig
{
    private Hifig()
    {
    }
